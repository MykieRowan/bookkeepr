...
try {
console.log(`Telling Prowlarr to grab release...`);
console.log(`  Indexer ID: ${indexerId}`);
...
console.log(`  Prowlarr response: ${response.status}`);
return response.data;
```
...
// Grab the release - this tells Prowlarr to download and send to qBittorrent
